...
tap.test("Record Import Page", t => {
    adminLogin(() => {
        const url = "http://localhost:3000/artworks/source/test/admin" + "?records=test/started";
        request.get(url, (err, res) => {
            t.error(err, "Error should be empty.");
            t.equal(res.statusCode, 200);
            t.end();
...
tap.test("Record Import Page (Completed)", t => {
    adminLogin(() => {
        const url = "http://localhost:3000/artworks/source/test/admin" + "?records=test/completed";
        request.get(url, (err, res) => {
            t.error(err, "Error should be empty.");
            t.equal(res.statusCode, 200);
            t.end();
...
tap.test("Record Import Page (Error)", t => {
    adminLogin(() => {
        const url = "http://localhost:3000/artworks/source/test/admin" + "?records=test/error";
        request.get(url, (err, res) => {
            t.error(err, "Error should be empty.");
            t.equal(res.statusCode, 200);
            t.end();
...
tap.test("Record Import Page (Missing)", t => {
    adminLogin(() => {
        const url = "http://localhost:3000/artworks/source/test/admin" + "?records=test/foo";
        request.get(url, (err, res) => {
            t.error(err, "Error should be empty.");
...
tap.test("Record Import Finalize", t => {
    adminLogin(() => {
        const url = "http://localhost:3000/artworks/source/test/admin" + "?records=test/started&finalize=true";
        request.get(url, (err, res) => {
            t.error(err, "Error should be empty.");
            t.equal(res.statusCode, 200);
...
tap.test("Record Import Abandon", t => {
    adminLogin(() => {
        const url = "http://localhost:3000/artworks/source/test/admin" + "?records=test/started&abandon=true";
        request.get(url, (err, res) => {
            t.error(err, "Error should be empty.");
            t.equal(res.statusCode, 200);
            t.match(res.request.uri.href, "http://localhost:3000/artworks/source/test/admin");
...
tap.test("Image Import Page", t => {
    adminLogin(() => {
        const url = "http://localhost:3000/artworks/source/test/admin" + "?images=test/started";
        request.get(url, (err, res) => {
            t.error(err, "Error should be empty.");
            t.equal(res.statusCode, 200);
            t.end();
...
tap.test("Image Import Page (Completed)", t => {
    adminLogin(() => {
        const url = "http://localhost:3000/artworks/source/test/admin" + "?images=test/completed";
        request.get(url, (err, res) => {
            t.error(err, "Error should be empty.");
            t.equal(res.statusCode, 200);
            t.end();
...
tap.test("Image Import Page (Completed, Expanded)", t => {
    adminLogin(() => {
        const url = "http://localhost:3000/artworks/source/test/admin" + "?images=test/completed&expanded=models";
        request.get(url, (err, res) => {
            t.error(err, "Error should be empty.");
            t.equal(res.statusCode, 200);
            t.end();
...
tap.test("Image Import Page (Error)", t => {
    adminLogin(() => {
        const url = "http://localhost:3000/artworks/source/test/admin" + "?images=test/error";
        request.get(url, (err, res) => {
            t.error(err, "Error should be empty.");
            t.equal(res.statusCode, 200);
            t.end();
...
tap.test("Image Import Page (Missing)", t => {
    adminLogin(() => {
        const url = "http://localhost:3000/artworks/source/test/admin" + "?images=test/foo";
        request.get(url, (err, res) => {
            t.error(err, "Error should be empty.");
            t.equal(res.statusCode, 404);
            t.end();
...
tap.test("uploadData: No files", t => {
    adminLogin(() => {
        const url = "http://localhost:3000/artworks/source/test/upload-data";
        const formData = {};
...
tap.test("uploadImages: Source not found", t => {
    adminLogin(() => {
        const url = "http://localhost:3000/artworks/source/foo/upload-images";
        const formData = {};
        request.post({ url, formData }, (err, res) => {
            t.error(err, "Error should be empty.");
            t.equal(res.statusCode, 404);
...
tap.test("uploadImages: No files", t => {
    adminLogin(() => {
        const url = "http://localhost:3000/artworks/source/test/upload-images";
        const formData = {};
        request.post({ url, formData }, (err, res, body) => {
            t.error(err, "Error should be empty.");
            t.equal(res.statusCode, 500);
